...
namespace Marten.Events.V4Concept.CodeGeneration
{
    internal class AggregationTypeBuilder
    {
        ...
        private void buildInlineAggregationType()
        {
            ...
            // This gets you the EventStream Id
            method.DerivedVariables.Add(Variable.For<Guid>($"stream.{nameof(EventStream.Id)}"));
            method.DerivedVariables.Add(Variable.For<string>($"stream.{nameof(EventStream.Key)}"));
